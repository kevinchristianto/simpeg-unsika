    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Master Data Golongan</span>
            </div>
        ...
        <div class="header-elements d-none">
            <div class="breadcrumb justify-content-center">
                <a href="#" class="breadcrumb-elements-item" data-toggle="modal" data-target="#add-golongan">
        ...
        <div class="col-md-8 col-12 mx-md-auto">
            <div class="card border-left-teal border-left-2 rounded-left-0">
                <div class="card-header">
                    <h5 class="card-title font-weight-bold text-teal">Data Golongan</h5>
                </div>
                <div class="card-body">
...
<div class="modal fade" id="add-golongan">
