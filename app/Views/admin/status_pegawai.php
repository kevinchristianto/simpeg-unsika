    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Master Data Status Pegawai</span>
            </div>
        ...
        <div class="header-elements d-none">
            <div class="breadcrumb justify-content-center">
                <a href="#" class="breadcrumb-elements-item" data-toggle="modal" data-target="#add-status-pegawai">
                    <i class="icon-plus22"></i>
                    Tambah Data Status Pegawai
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-8 col-12 mx-md-auto">
            <div class="card border-left-teal border-left-2 rounded-left-0">
                <div class="card-header">
                    <h5 class="card-title font-weight-bold text-teal">Data Status Pegawai</h5>
                </div>
                <div class="card-body">
...
<div class="modal fade" id="add-status-pegawai">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('status-pegawai/insert/'); ?>" method="POST">
                    <div class="form-group">
                        <label>Kode Status Pegawai</label>
                        <input type="text" class="form-control" name="id">
                    </div>
                    <div class="form-group">
                        <label>Nama Status Pegawai</label>
                        <input type="text" class="form-control" name="nama_status-pegawai">
                    </div>
                    <div class="form-group">
