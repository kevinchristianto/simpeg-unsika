    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Master Data Jabatan Pegawai</span>
            </div>
        ...
        <div class="header-elements d-none">
            <div class="breadcrumb justify-content-center">
                <a href="#" class="breadcrumb-elements-item" data-toggle="modal" data-target="#add-jabatan-pegawai">
                    <i class="icon-plus22"></i>
                    Tambah Data Jabatan Pegawai
                </a>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $row['id']; ?></td>
                                    <td><?= $row['nama_jabatan_pegawai']; ?></td>
...
<div class="modal fade" id="add-jabatan-pegawai">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('jabatan-pegawai/insert/'); ?>" method="POST">
                    <div class="form-group">
                        <label>Kode Jabatan Pegawai</label>
                        <input type="text" class="form-control" name="id">
                    </div>
                    <div class="form-group">
                        <label>Nama Jabatan Pegawai</label>
                        <input type="text" class="form-control" name="nama_jabatan-pegawai">
                    </div>
                    <div class="form-group">
